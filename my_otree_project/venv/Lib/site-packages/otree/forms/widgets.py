...
class DecimalWidget(BaseWidget):
    ...
    def get_html_fragments(self):
        ...
        min_val = self.render_kw.get('min')
        ...
        if self.input_label:
            yield f'<span class="input-group-text">{escape(self.input_label)}</span>'
...
class BaseRadioSelect(BaseWidget):
    has_value = False

    def get_subfield_htmls(self):
...
class RadioSelect(BaseRadioSelect):
    def get_html_fragments(self):
        ...
        for subfield, subfield_html in self.get_subfield_htmls():
...
class RadioSelectHorizontal(BaseRadioSelect):
    def get_html_fragments(self):
        for subfield, subfield_html in self.get_subfield_htmls():
            yield f'''
