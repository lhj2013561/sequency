...
<html lang="en">
    <head>
        <title>{{ session.code|truncate_(4) }}/{{ page_emoji }} Split Screen Demo</title>
        ...
        <style>
            ...
            .participant-frames iframe {
                ...
                /* without this, the iframes overflow and scroll horizontally */
                min-width: 0;
                /* if i set:
                height: 100%;
    ...
    <body>
        <iframe class="monitor-frame" src="{% url 'SessionMonitor' session.code %}?scrsplit=true"></iframe>
